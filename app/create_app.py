...
def create_app():
    ...
    with app.app_context():
        ...
        #offer = load_offer(r"C:\Users\okuro\PycharmProjects\HW_16\data\offers.json")
        #user = load_user("users.json")
        #order = load_order("orders.json")
        offer = load_offer(r"C:\Users\okuro\PycharmProjects\HW_16\data\offers.json")
        user = load_user(r"C:\Users\okuro\PycharmProjects\HW_16\data\users.json")
        order = load_order(r"C:\Users\okuro\PycharmProjects\HW_16\data\orders.json")
